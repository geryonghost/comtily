...
function MarkerClusterer(map, opt_markers, opt_options) {
     ...
     */
    this.gridSize_ =
        options['gridSize'] !== undefined ? options['gridSize'] : 60
...
ClusterIcon.prototype.triggerClusterMouseout = function (event) {
    ...
    if (
        typeof this.cluster_.markerClusterer_.onMouseoutCluster_ === 'function'
    ) {
